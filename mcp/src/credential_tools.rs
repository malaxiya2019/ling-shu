...
impl Tool for CredentialValidateTool {
    ...
    fn duplicate(&self) -> Box<dyn Tool> {
        Box::new(CredentialValidateTool {
            mgr: self.mgr.clone(),
        })
    }
}
