...
pub struct Translations {
    ...
    pub nav_tenant: &'static str,
    pub nav_audit: &'static str,
    pub audit_title: &'static str,
    pub audit_total_entries: &'static str,
    pub audit_displayed: &'static str,
    pub audit_no_entries: &'static str,
    pub audit_col_time: &'static str,
    pub audit_col_type: &'static str,
    pub audit_col_event: &'static str,
    pub audit_col_actor: &'static str,
    pub audit_col_resource: &'static str,
    pub audit_col_result: &'static str,
    pub audit_col_detail: &'static str,
...
const EN: Translations = Translations {
    ...
    audit_total_entries: "Total Entries",
    audit_displayed: "Displayed",
...
const ZH: Translations = Translations {
    ...
    audit_title: "📋 审计日志",
    audit_total_entries: "总条目数",
    audit_displayed: "已显示",
    audit_no_entries: "暂无审计记录",
    audit_col_time: "时间",
    audit_col_type: "类型",
    audit_col_event: "事件",
    audit_col_actor: "操作者",
    audit_col_resource: "资源",
    audit_col_result: "结果",
    audit_col_detail: "详情",
};
